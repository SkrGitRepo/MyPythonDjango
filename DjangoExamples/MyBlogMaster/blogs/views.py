...
def index(request):
    ...
    page_title = 'Home'
    meta_keywords = 'Skr, Skumar, SUMIT, KUMAR, SUMIT KR, JHA, Raja, Sumit kumar jha, Sumit Kumar'
    meta_description = 'A site by Sumit_skr, devoted to his Learning in programming.'
    no = blogs.count()
...
def contact(request):
    ...
    categories = Categories.objects.all()
    page_title = 'Contact'
    meta_keywords = 'Contact Sumit_skr'

    meta_description = 'Contact Sumit_skr'
    no = blogs.count()
